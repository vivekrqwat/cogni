...
function P({key,color,c1,c,c2,d}) {
    // console.log(c,c1)
    console.log("c1:",c1)
  return (
  <Paper sx={{
    ...
    sx={{background:"#f8f9fa"}}>
        ...
        color={color}
        bgcolor={c2}
        justifyContent={"center"} alignItems={"center"} fontWeight={"600"} letterSpacing={"-0.3px"}>{c}</Box>
    ...
    >
        <Typography sx={{width:{sm:"73%",xs:"60%"}}}>
            {/* Background Details:what needs to be done and why,what needs to be disruted .lorem dolar sit amet */}
        </Typography>
    </Box>
    ...
    >
        ...
        {c==="open"?<Switch defaultChecked></Switch>:<Switch ></Switch>}
       <Typography
       sx={{color:color}}>
        {c}</Typography> 
        </Box>
